...
interface MobileControlsProps {
  sendJoystickState: (f: boolean, b: boolean, l: boolean, r: boolean) => void;
}
...
const MobileControls: React.FC<MobileControlsProps> = ({
  ...
  const [activeControls, setActiveControls] = useState<ControlState>({
    forward: false,
    backward: false,
    left: false,
    right: false,
        ...
        <div className="w-full mt-10 p-4 flex justify-center gap-2 ">
          <div
            ...
            onTouchStart={() => {
              ...
              sendJoystickState(forward.current, backward.current, left.current, right.current);
